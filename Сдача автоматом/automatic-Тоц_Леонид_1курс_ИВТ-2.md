...
- **Вход.** Арифметическое выражение в постфиксной форме, где операнды (целые числа) и операции +, -, *,
/ разделены пробелами. Например: 5 3 2 * +.
...
|----------------|----------------|--------------------|
| stack          | Stack*         | указатель на стек  |
| str            | char*          | Оператор / операнд |
| left           | int            | Первый операнд     |
| right          | int            | Второй операнд     |
